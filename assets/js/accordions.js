...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_mouseStart: function(event) {
		...
		//Store the helper's index.css position
		...
		// Reset helper's right/bottom index.css if they're set and set explicit width/height instead
...
$.effects.animateClass = function( value, duration, easing, callback ) {
	...
	return this.queue( function() {
		...
		$.when.apply( $, allAnimations.get() ).done(function() {
			...
			// clear all index.css properties that were animated
...
var sortable = $.widget("ui.sortable", $.ui.mouse, {
	...
	_generatePosition: function(event) {
		...
		// 1. If the index.css position is relative
