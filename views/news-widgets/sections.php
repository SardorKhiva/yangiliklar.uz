                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="blog-post">
                                ...
                                <div class="down-content">
                                    <span>Lifestyle</span>
                                    <a href="../news-details.php"><h4>Donec tincidunt leo</h4></a>
                                    <ul class="post-info">
                        ...
                        <div class="col-lg-6">
                            <div class="blog-post">
                                ...
                                <div class="down-content">
                                    <span>Lifestyle</span>
                                    <a href="../news-details.php"><h4>Suspendisse et metus</h4></a>
                                    <ul class="post-info">
                                        <li><a href="#">Admin</a></li>
                        ...
                        <div class="col-lg-6">
                            <div class="blog-post">
                                ...
                                <div class="down-content">
                                    <span>Lifestyle</span>
                                    <a href="../news-details.php"><h4>Mauris ac dolor ornare</h4></a>
                                    <ul class="post-info">
                                        <li><a href="#">Admin</a></li>
